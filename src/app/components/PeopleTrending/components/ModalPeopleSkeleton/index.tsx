function SkeletonModalPeople() {
  return (
    <div className="flex flex-row w-full animate-pulse h-auto gap-5 justify-start md:justify-start lg:justify-center">
...
export default SkeletonModalPeople;
